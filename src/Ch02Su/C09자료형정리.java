...
public class C09자료형정리 {
	...
	public static void main(String[] args) {
		...
		//byte : 1byte정수(음수저장o) (-128~127)
		//byte var5 = 127;
		//byte var6 = 128; 	//불가능:범위를 벗어남
		//byte var7 = -129;	//불가능:범위를 벗어남
		
		//short : 2byte 정수(음수지원o)(-32768~32767)
		//char  : 2byte 정수(음수지원x - 1문자 저장용도)(0~65535)
		//long  : 8byte 정수(음수지원o) 리터럴 접미사: l,L
